...
import os
os.chdir("C:/Users/ediaz/OneDrive - up.edu.mx/Research/ENIGH - Majo Favela/Python_MMP_2020")
os.getcwd()
...
work_df = pd.read_csv('Bases de datos/trabajos.csv', low_memory=False, dtype = str)
...
income_df = pd.read_csv('Bases de datos/ingresos.csv', low_memory=False, dtype = str)
...
population_df = pd.read_csv('Bases de datos/poblacion.csv', low_memory=False, dtype = str)
